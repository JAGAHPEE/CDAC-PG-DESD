...
// following needs to be changed according to project.
#define _W25QXX_SPI                   hspi1
#define _W25QXX_CS_GPIO               GPIOA
#define _W25QXX_CS_PIN                GPIO_PIN_4

// following needs to be changed if required
#define _W25QXX_USE_FREERTOS          0                          // enable this only if you use FreeRTOS
#define _W25QXX_DEBUG                 0							 // enable this if you want debug info.
	typedef enum
	{
		W25Q10 = 1,
		W25Q20,
